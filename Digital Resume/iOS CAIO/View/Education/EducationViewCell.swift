...
class EducationViewCell: UITableViewCell {
    ...
    lazy var graduateName: UILabel = {
        ...
        graduate.textColor = UIColor.black
    ...
    lazy var graduateDescription: UILabel = {
        ...
        graduateDescription.textColor = UIColor.black
    ...
    private func configureLayout() {
        ...
        if DeviceType.isIphone5 {
            ...
            graduateName.font = UIFont(name: "Nunito-SemiBold", size: 13)
            
            graduateDescription.font = UIFont(name: "Nunito-SemiBold", size: 13)

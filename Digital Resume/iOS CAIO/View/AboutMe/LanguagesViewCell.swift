...
//  iOS CAIO
//
//  Created by Venkata Prabhu on 13.01.2024.
//
...
class LanguagesViewCell: UITableViewCell {
    ...
    var teluguLevelFrame: CGFloat? {
        didSet {
            guard let frame = teluguLevelFrame else { return }
            teluguLevel.frame = .init(x: 0, y: 0, width: frame, height: 6)
            teluguLevel.trailingAnchor.constraint(equalTo: teluguLevelBackground.trailingAnchor, constant: -2).isActive = true
           // teluguLevel.trailingAnchor.constraint(equalTo: teluguLevelBackground.trailingAnchor, constant: -(ConstraintsManager.width * 0.3)).isActive = true
    ...
    lazy var teluguLevelBackground: UIView = {
        let line = UIView()
    ...
    private func configureLayout() {
        ...
        addSubview(cellView)
        cellView.addSubview(telugu)
        cellView.addSubview(teluguLevelBackground)
        ...
        teluguLevel.translatesAutoresizingMaskIntoConstraints = false
        ...
        NSLayoutConstraint.activate([
            ...
            telugu.topAnchor.constraint(equalTo: cellView.topAnchor, constant: 20),
            telugu.leadingAnchor.constraint(equalTo: cellView.leadingAnchor, constant: 20),
            
            teluguLevelBackground.topAnchor.constraint(equalTo: telugu.bottomAnchor, constant: 5),
            teluguLevelBackground.leadingAnchor.constraint(equalTo: cellView.leadingAnchor, constant: 20),
            teluguLevelBackground.widthAnchor.constraint(equalToConstant: (ConstraintsManager.width * 0.8) - 15),
            teluguLevelBackground.heightAnchor.constraint(equalToConstant: 10),
            
            teluguLevel.centerYAnchor.constraint(equalTo: teluguLevelBackground.centerYAnchor),
            teluguLevel.leadingAnchor.constraint(equalTo: teluguLevelBackground.leadingAnchor, constant: 2),
            teluguLevel.heightAnchor.constraint(equalToConstant: 6),
            
            
            english.topAnchor.constraint(equalTo: teluguLevelBackground.bottomAnchor, constant: 20),

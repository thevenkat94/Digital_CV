...
//  iOS CAIO
//
//  Created by Caio Chaves on 18.10.2023.
//
...
class AboutMeViewController: UIViewController {
    ...
    private func configureLayout() {
        ...
        background.image = UIImage(named: "MyPicture")
...
//                }
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 1.5) {
                    customCell.teluguLevelFrame = 0
                    UIView.animate(withDuration: 1.5, delay: 0, options: .curveEaseIn) {
//                    customCell.teluguLevelFrame = ((ConstraintsManager.width * 0.2) - 30)
                        customCell.teluguLevelFrame = (ConstraintsManager.width * 0.5)

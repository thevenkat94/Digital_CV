...
//  iOS CAIO
//
//  Created by Venkata Prabhu on 12.01.2024.
//
...
class ContactsSheetViewController: UIViewController {
    ...
    lazy var callButton: CustomButton = {
        ...
        let number = CustomButton(icon: icon!, text: "+91 900 8918 718")
        return number
    }()
    ...
    lazy var linkedinButton: CustomButtonAttributedText = {
        ...
        let button = CustomButtonAttributedText(icon: icon!, text: "linkedin.com/in/u1venkatp1" , target: self, action: #selector(linkedinDidTapped))
